...
public class TagSheet {
    ...
    private static final Logger _logger = Logger.getLogger(TagSheet.class.getName());
    ...
    public static void main(String[] args) {
        String filename = "C:\\Temp\\" + PDF_FILENAME;
        TagSheet ts = new TagSheet(new File("W:\\cacb-review-generated\\artifact"));
        try {
            ts.writeTagSheet(new File(filename));
        } catch (IOException | DocumentException ex) {
            String stack = ExceptionUtils.getStackTrace(ex);
            _logger.log(Level.SEVERE,"Could not write tag sheet {0}. Caught exception:\n\n{1}",
                    new Object[]{filename,stack});
        }
    }
