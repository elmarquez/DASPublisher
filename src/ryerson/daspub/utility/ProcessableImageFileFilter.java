 ...
 * @author dmarques
 */
public class ProcessableImageFileFilter implements FilenameFilter {
    ...
    public boolean accept(File dir, String name) {
        ...
        boolean match = false;
        int j = 0;
        while (!match && j < Config.PROCESSABLE_IMAGE_TYPES.length) {
            String type = Config.PROCESSABLE_IMAGE_TYPES[j];
            if (ext.equals(type)) {
                match = true;
            }
            j++;
